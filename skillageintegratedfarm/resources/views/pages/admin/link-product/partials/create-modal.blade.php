<div id="add-link-product-modal" tabindex="-1"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="add-link-product-modal">
            ...
            <form action="{{ route('link-product.store') }}" method="POST">
                @csrf
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="text" name="marketplace_name" id="marketplace_name"
                                ...
                                placeholder="Masukkan judul link produk" required="">
                ...
                <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                    ...
                    <button type="button" data-modal-hide="add-link-product-modal"
