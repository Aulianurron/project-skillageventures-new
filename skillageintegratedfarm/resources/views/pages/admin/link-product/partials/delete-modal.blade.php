<div id="delete-link-product-{{ $item->id }}" tabindex="-1"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="delete-link-product-{{ $item->id }}">
            ...
            <form action="{{ route('link-product.destroy', $item->id) }}" method="POST" id="delete-link-product-form">
                @csrf
                @method('DELETE')
                <div class="p-6 space-y-6">
                    <p class="text-sm text-gray-700 dark:text-gray-300">Anda yakin ingin menghapus berita ini?
                    </p>
                </div>
                <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                    ...
                    <button type="button" data-modal-hide="delete-link-product-{{ $item->id }}"
