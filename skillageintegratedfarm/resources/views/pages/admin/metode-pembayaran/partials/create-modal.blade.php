<div id="add-metode-pembayaran-modal" tabindex="-1"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="add-payment-modal">
            ...
            <form enctype="multipart/form-data" action="{{ route('metode-pembayaran.store') }}" method="POST">
                @csrf
