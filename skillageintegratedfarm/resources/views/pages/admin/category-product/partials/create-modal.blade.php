            ...
            <form action="{{ route('category-product.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="p-6 space-y-6">
                    <div class="mb-4">
                        ...
                        @enderror
                        <input name="photo"
                                class="block mt-3 w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                ...
                <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                    ...
                    <button type="button" data-modal-hide="add-category-modal"
