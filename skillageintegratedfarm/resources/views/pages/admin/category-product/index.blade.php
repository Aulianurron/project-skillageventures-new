    ...
    @section('admin')
        <div
            ...
            <div class="w-full mb-1">
                <div class="mb-4">
                    <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Manajemen Kategori Produk
                    </h1>
                </div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                @foreach ($categories as $category)
                                    <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                        ...
                                        <td
                                            class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                            <img src="{{ asset($category->photo) }}" alt="Avatar"
                                    ...
                                    @include('pages.admin.category-product.partials.edit-modal', [
                                        'category' => $category,
                                    ])
                                    @include('pages.admin.category-product.partials.delete-modal', [
                                        'category' => $category,
                                    ])
                                @endforeach
                            </tbody>
        ...
        @include('pages.admin.category-product.partials.create-modal')
    @endsection
</x-admin-layout>
