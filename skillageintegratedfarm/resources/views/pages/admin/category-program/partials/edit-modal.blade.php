<div id="edit-category-{{ $category->id }}" tabindex="-1"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="edit-category-{{ $categories[0]->id }}">
            ...
            <form action="{{ route('category-program.update', $category->id) }}" method="POST" id="edit-category-form" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <div class="col-span-6">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                ...
                                Gambar</label>
                            <img src="{{ asset($category->photo) }}" alt="Gambar Produk"
                ...
                <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                    ...
                    <button type="button" data-modal-hide="edit-category-{{ $category->id }}"
