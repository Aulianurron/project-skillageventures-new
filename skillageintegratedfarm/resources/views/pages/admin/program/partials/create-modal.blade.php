        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="add-program-modal">
            ...
            <form enctype="multipart/form-data" action="{{ route('program.store') }}" method="POST">
                @csrf
                <div class="p-6 space-y-6">
                        <label for="name"
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300">Nama program</label>
                        ...
                        <label for="description"
                            class="block mt-3 text-sm font-medium text-gray-700 dark:text-gray-300">Deskripsi</label>
                        ...
                        <!-- Gambar -->
                        <input type="file" name="image" id="image" class="block w-full mt-1 text-sm text-gray-900 border-gray-300 rounded-lg cursor-pointer dark:text-gray-400 focus:outline-none" onchange="previewImage(event)" required>
                        <!-- Preview Image Element -->
                        <img id="preview" class="mt-4 w-32 h-32 object-cover" src="#" alt="Preview Image" style="display: none;">
                        @error('image ')
                            <span class="text-red-500 text-sm">{{ $message }}</span>
                        @enderror

                        {{-- file --}}
                        <input type="file" name="document_program" id="document_program" class="block w-full mt-1 text-sm text-gray-900 border-gray-300 rounded-lg cursor-pointer dark:text-gray-400 focus:outline-none" required>
                        ...
                        {{-- category program --}}
                            <label for="category_program_id"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kategori program</label>
                ...
                <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                    ...
                    <button type="button" data-modal-hide="add-program-modal"
