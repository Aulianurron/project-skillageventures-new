<div id="add-personnel-modal" tabindex="-1"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            <div class="flex items-start justify-between p-4 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-hide="add-personnel-modal">
            ...
            <form action="{{ route('personnel.store') }}" method="POST">
                ...
                <div class="p-6 space-y-6 max-h-[75vh] overflow-y-auto">
                    ...
                    <div class="col-span-6">
                        ...
                        <textarea name="biography" id="content" rows="4"
                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder="Masukkan isi biografi"></textarea>
                    </div>
                    @error('biography')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                ...
                <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                    ...
                    <button type="button" data-modal-hide="add-personnel-modal"
