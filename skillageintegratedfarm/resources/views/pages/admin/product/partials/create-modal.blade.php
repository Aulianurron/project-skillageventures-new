<div id="add-product-modal" tabindex="-1"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
            ...
            <form action="{{ route('product.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            <label for="category_product"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kategori produk</label>
                            <select name="category_product_id" id="category_product"
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            <label for="tokopedia"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">tokopedia</label>
                            <select name="tokopedia" id="tokopedia"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                required>
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            <label for="capital_price"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Harga Modal</label>
                ...
                <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                    ...
                    <button type="button" data-modal-hide="add-product-modal"
