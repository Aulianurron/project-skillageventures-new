<div id="edit-expense-{{ $expenses}}" tabindex="-1"
    ...
    <div class="relative w-full max-w-2xl max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form action="{{ route('management-expense.update', $expense->id) }}" method="POST" id="edit-category-form" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                    ...
                    <button type="button" data-modal-hide="edit-category-{{ $expense->id }}"
