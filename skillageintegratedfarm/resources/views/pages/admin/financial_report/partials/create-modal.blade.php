<div id="add-expense-modal" tabindex="-1"
    ...
    <div class="relative w-full max-w-2xl max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <form action="{{ route('management-expense.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="p-6 space-y-6">
                    <div class="mb-4">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <select name="category_expenses_id" id="category_expense"
