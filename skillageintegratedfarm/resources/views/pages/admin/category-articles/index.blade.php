    ...
    @section('admin')
        <div
            ...
            <div class="w-full mb-1">
                <div class="mb-4">
                    <h1 class="text-xl font-semibold text-gray-900 sm:text-2xl dark:text-white">Manajemen Kategori Artikel
                    </h1>
                </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 table-fixed dark:divide-gray-600">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                                @foreach ($categories as $category)
                                    ...
                                    @include('pages.admin.category-articles.partials.edit-modal', [
                                        'category' => $category,
                                    ])
                                    @include('pages.admin.category-articles.partials.delete-modal', [
                                        'category' => $category,
                                    ])
                                @endforeach
                            </tbody>
        ...
        @include('pages.admin.category-articles.partials.create-modal')
    @endsection
</x-admin-layout>
