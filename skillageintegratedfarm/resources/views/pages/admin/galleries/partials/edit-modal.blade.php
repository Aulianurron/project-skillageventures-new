<div id="edit-news-{{ $item->id }}" tabindex="-1"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-800">
            <div class="flex items-start justify-between p-5 border-b rounded-t dark:border-gray-700">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="edit-news-{{ $item->id }}">
            ...
            <div class="p-6 space-y-6 max-h-[75vh] overflow-y-auto">
                <form action="{{ route('news.update', $item->id) }}" method="POST" id="edit-news-form" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="grid grid-cols-6 gap-6">
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <input type="text" name="title" id="title"
                                ...
                                value="{{ $item->title }}" placeholder="Masukkan judul berita" required="">
                            @error('title')
                        ...
                        <div class="col-span-6">
                            ...
                            <textarea id="content" name="content" rows="4"
                                ...
                                placeholder="Masukkan isi berita">{{ old('content', $item->content) }}</textarea>
                            @error('content')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-span-6">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
                                ...
                                Gambar</label>
                            <img src="{{ asset($item->image) }}" alt="Gambar Berita"
                    ...
                    <div
                        ...
                        <button type="button" data-modal-hide="edit-news-{{ $item->id }}"
